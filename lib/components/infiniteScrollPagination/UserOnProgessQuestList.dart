...
//   @override
//   _UserOnProgressQuestListState createState() => _UserOnProgressQuestListState();
// }
...
//       bool isSuccess = await UserQuestMongodb.fetchUserOnProgressQuest();
...
//   void _unBookmarkOnProgressQuest(OnProgressQuestSummary quest) async {
//     print('check 2 : $quest');
...
//             bool isBookonProgress = bookmarkStatus[item.objectId] ?? false;
//             return QuestListItem(
//               quest: item,
//               colorPattern: questColors[index % questColors.length],
//               isBookmark: isBookonProgress,
//               unBookmarkCallback: _unBookmarkOnProgressQuest,
//             );
//           },
...
//   final Function(OnProgressQuestSummary) unBookmarkCallback;
